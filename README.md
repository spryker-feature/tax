...
## Optional modules
- [ProductTaxSetsRestApi ^2.5.0](https://github.com/spryker/product-tax-sets-rest-api) (Legacy Glue)
- [TaxMerchantPortalGui ^1.0.0](https://github.com/spryker/tax-merchant-portal-gui) (MP GUI)
- [TaxProductConnector ^4.12.0](https://github.com/spryker/tax-product-connector) (Connector)
